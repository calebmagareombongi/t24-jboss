<%@page import="com.temenos.arc.security.filter.Constant"%>
<%
...
<div id="content">
	<center>
			<form id="FtressPasswordForm" method="post" target="<%=request.getContextPath()%>/servlet/FtressTransactionServlet" action="<%=request.getContextPath()%>/servlet/FtressTransactionServlet" AUTOCOMPLETE="OFF">
				<input type="hidden" name="applctn" id="applctn" value="<%=session.getAttribute(Constant.CURR_APP_NAME) %>" />
				<input type="hidden" name="txnID" id="txnID" value="<%=session.getAttribute(Constant.CURR_TXN_ID) %>" />
				<input type="hidden" name="cmpID" id="cmpID" value="<%=session.getAttribute(Constant.CURR_COMP_ID) %>" />
				<input type="hidden" name="usrID" id="usrID" value="<%=session.getAttribute(Constant.CURR_USER_ID) %>" />
				<% 
