...
<table id="container">
	<tbody>
		<tr>
			<td nowrap width="50%">
			<form name="login" method="post" action="<%=request.getContextPath()%>/servlet/BrowserServlet" AUTOCOMPLETE="OFF">
			<input type="hidden" name="command" value="login">
			<input type="hidden" name="requestType" value="CREATE.SESSION"/>
			<input type="hidden" name="counter" value="0">
			<div id="login-window"><span id="title">LDAP Single Sign On</span> <br>			
			<table>
				<tr>
					<td colspan="3"></td>
				</tr>
				<tr>
					...
					<td nowrap><input type="password" id="signOnName"
						name="signOnName" tabindex="1" size="30" value=""></td>
				...
				<tr>
					...
					<td nowrap><input type="password" id="password"
						name="password" tabindex="2" size="30" value=""></td>
				</tr>
				<tr>
					<td colspan="3"><img alt=""
						src="../plaf/images/default/block.gif"></td>
