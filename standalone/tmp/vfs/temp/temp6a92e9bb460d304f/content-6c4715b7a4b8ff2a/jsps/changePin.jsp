   ...
   %>
	<div id = "content">
 	<table border="0" width="994"> 
		 ...
		 <form name="FtressPasswordForm" target="<%=request.getContextPath()%>/servlet/protected/FtressChangePinServlet" AUTOCOMPLETE="OFF"> 
            <table class="input">
                <tr>
				...
				<tr>
					<td colspan="2" class="reminder">
						(This pin will be used ID for online and phone banking services)
					</td>
				</tr>
				<tr>
					<td colspan="2">
