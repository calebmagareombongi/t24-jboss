					...
					<xsl:choose>
						...
						<xsl:when test="ty='SEARCH'">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									...
									<xsl:attribute name="href">javascript:doSearch('<xsl:value-of select="tar" />');</xsl:attribute>
								</xsl:otherwise>
							</xsl:choose>
						...
						<xsl:when test="ty='ENQUIRY'">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:attribute name="onclick">javascript:menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />');processMenuHeaderText('<xsl:value-of select="$EscapeChars" />')</xsl:attribute>
									<xsl:attribute name="href">javascript:doenq('<xsl:value-of select="tar" />');</xsl:attribute>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:call-template name="generateImage">
								<xsl:with-param name="imgSource">/menu/enquiry.gif</xsl:with-param>
						...
						<xsl:when test="ty='ENQ.LAUNCH'">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:attribute name="onclick">javascript:menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />')</xsl:attribute>
									<xsl:attribute name="href">javascript:doenqRun('<xsl:value-of select="tar" />');</xsl:attribute>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:call-template name="generateImage">
						...
						<xsl:when test="ty='ENQ.LIST'">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:attribute name="onclick">javascript:menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />')</xsl:attribute>
									<xsl:attribute name="href">javascript:doenqList('<xsl:value-of select="tar" />');</xsl:attribute>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:call-template name="generateImage">
								<xsl:with-param name="imgSource">/menu/runenquiry.gif</xsl:with-param>
						...
						<xsl:when test="ty='ENQ.SEARCH'">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:attribute name="onclick">javascript:menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />')</xsl:attribute>
									<xsl:attribute name="href">javascript:doenqSearch('<xsl:value-of select="tar" />');</xsl:attribute>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:call-template name="generateImage">
								<xsl:with-param name="imgSource">/menu/runenquiry.gif</xsl:with-param>
						...
						<xsl:when test="ty='CONTRACT'">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:attribute name="onclick">javascript:menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />');processMenuHeaderText('<xsl:value-of select="$EscapeChars" />')</xsl:attribute>
									<xsl:attribute name="href">javascript:docommand('<xsl:value-of select="tar" />');</xsl:attribute>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:call-template name="generateImage">
						...
						<xsl:when test="ty='CHANGE.COMPANY'">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:attribute name="onclick">javascript:menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />')</xsl:attribute>
									<xsl:attribute name="href">javascript:doloadCompany('<xsl:value-of select="tar" />');</xsl:attribute>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:call-template name="generateImage">
						...
						<xsl:when test="ty='CHANGE.ROLE'">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:attribute name="onclick">javascript:menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />')</xsl:attribute>
									<xsl:attribute name="href">javascript:doSwitchRole('<xsl:value-of select="tar" />');</xsl:attribute>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:call-template name="generateImage">
							...
							<xsl:choose>
								...
								<xsl:when test="ty='ACTION'">
									...
									<xsl:choose>
										...
										<xsl:otherwise>
											<xsl:attribute name="onclick">javascript:menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />')</xsl:attribute>
											<xsl:attribute name="href">javascript:doDeal('<xsl:value-of select="tar" />');</xsl:attribute>
										</xsl:otherwise>
									</xsl:choose>
								</xsl:when>
								<xsl:when test="ty='EDIT'">
									...
									<xsl:choose>
										...
										<xsl:otherwise>
											<xsl:attribute name="onclick">javascript:menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />')</xsl:attribute>
											<xsl:attribute name="href">javascript:doEdit('<xsl:value-of select="tar" />');</xsl:attribute>
										</xsl:otherwise>
									</xsl:choose>
								</xsl:when>
								<xsl:otherwise>
									...
									<xsl:choose>
										<xsl:when test="$showStatusInfo='false'">
											<xsl:attribute name="onclick">javascript:doutil('<xsl:value-of select="tar" />','issueToken');menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />')</xsl:attribute>
											<xsl:attribute name="href">javascript:void(0)</xsl:attribute>
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="onclick">javascript:menu_history('<xsl:value-of select="ty" />','<xsl:value-of select="tar" />')</xsl:attribute>
											<xsl:attribute name="href">javascript:doutil('<xsl:value-of select="tar" />','issueToken');</xsl:attribute>
										</xsl:otherwise>
									</xsl:choose>
								</xsl:otherwise>
							</xsl:choose>
