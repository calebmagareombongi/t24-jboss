            ...
            <body topmargin="2" leftmargin="2">
                ...
                <form name="help" method="POST" action="HelpServlet">
                    ...
                    <input type="hidden" name="version">
                        <xsl:attribute name="value"><xsl:value-of select="t24help/header/version"/></xsl:attribute>
                    </input>
                    <input type="hidden" name="versionxml">
                        <xsl:attribute name="value"><xsl:value-of select="t24help/header/versionxml"/></xsl:attribute>
                    </input>
                                                        ...
                                                        <a>
                                                            <xsl:choose>
                                                                <xsl:when test="$showStatusInfo='false'">
                                                                    <xsl:attribute name="onclick">javascript:viewCommonHelpFields()</xsl:attribute>
                                                                    <xsl:attribute name="href">javascript:void(0)</xsl:attribute>
                                                                </xsl:when>
                                                                <xsl:otherwise>
                                                                    <xsl:attribute name="href">javascript:viewCommonHelpFields()</xsl:attribute>
                                                                </xsl:otherwise>
                                                            </xsl:choose>
