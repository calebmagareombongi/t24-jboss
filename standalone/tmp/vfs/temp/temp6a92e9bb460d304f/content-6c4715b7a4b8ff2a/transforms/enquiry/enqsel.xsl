...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" size="20">
                                                    ...
                                                    <xsl:if test="(./popup='date' or ./popup='frequency') and not (/responseDetails/userDetails/allowcalendar)">
                                                                ...
                                                                <xsl:if test="not (enqsel/attribs/noMoreOptions)">
                                                                    <xsl:choose>
                                                                        <xsl:when test="$sortfields = '' and not($autoRefVal)">
                                                                            <a id="enqselopts_toggle{$formFragmentSuffix}" alt-text="{$hideOptsCaption}" tabindex = "0">
                                                                                ...
                                                                                <xsl:choose>
                                                                                    <xsl:when test="$showStatusInfo='false'">
                                                                                        <xsl:attribute name="onclick">javascript:EnqSel.toggleOptions()</xsl:attribute>
                                                                                        <xsl:attribute name="href">javascript:void(0)</xsl:attribute>
                                                                                    </xsl:when>
                                                                                    <xsl:otherwise>
                                                                                        <xsl:attribute name="href">javascript:EnqSel.toggleOptions()</xsl:attribute>
                                                                                    </xsl:otherwise>
                                                                                </xsl:choose>
                                                                                <xsl:value-of select="$moreOptsCaption"/>
                                                                            </a>
                                                                        </xsl:when>
                                                                        <xsl:otherwise>
                                                                            <a id="enqselopts_toggle{$formFragmentSuffix}" alt-text="{$moreOptsCaption}" tabindex = "0">
                                                                                <xsl:choose>
                                                                                    <xsl:when test="$showStatusInfo='false'">
                                                                                        <xsl:attribute name="onclick">javascript:EnqSel.toggleOptions()</xsl:attribute>
                                                                                        <xsl:attribute name="href">javascript:void(0)</xsl:attribute>
                                                                                ...
                                                                                <xsl:value-of select="$hideOptsCaption"/>
                                                                            </a>
                                                                        </xsl:otherwise>
                                                                    </xsl:choose>
                                                                </xsl:if>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a>
                                                                <xsl:choose>
                                                                    <xsl:when test="$showStatusInfo='false'">
                                                                        <xsl:attribute name="onclick">javascript:resetForm('enqsel')</xsl:attribute>
                                                                        <xsl:attribute name="href">javascript:void(0)</xsl:attribute>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <xsl:attribute name="href">javascript:resetForm('enqsel')</xsl:attribute>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                                <xsl:value-of select="$clearSelCaption" />
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    </xsl:if>
    ...
    <xsl:template name="dropdowns_and_popups">
        ...
        <xsl:if test="./dd!='' and not (/responseDetails/userDetails/allowdropdowns)">
            <a title="{$ddCaption}" popupDropField="{pdf}">
                <xsl:choose>
                    <xsl:when test="$showStatusInfo='false'">
                        <xsl:attribute name="onclick">javascript:enqselDropDown('value:<xsl:value-of select="i"/>:1:1', '<xsl:value-of select="dd"/>', '<xsl:value-of select="pdf"/>')</xsl:attribute>
                        <xsl:attribute name="href">javascript:void(0)</xsl:attribute>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:attribute name="href">javascript:enqselDropDown('value:<xsl:value-of select="i"/>:1:1', '<xsl:value-of select="dd"/>', '<xsl:value-of select="pdf"/>')</xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
            <xsl:call-template name="processTabIndex">
            ...
            <a>
                <xsl:choose>
                    <xsl:when test="$showStatusInfo='false'">
                        <xsl:attribute name="onclick">javascript:enqselDropDown('value:<xsl:value-of select="i"/>:1:1', '<xsl:value-of select="dd"/>', '<xsl:value-of select="pdf"/>','Yes')</xsl:attribute>
                        <xsl:attribute name="href">javascript:void(0)</xsl:attribute>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:attribute name="href">javascript:enqselDropDown('value:<xsl:value-of select="i"/>:1:1', '<xsl:value-of select="dd"/>', '<xsl:value-of select="pdf"/>','Yes')</xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
                <xsl:call-template name="processTabIndex">
                    <xsl:with-param name="type" select="'tabIndexForDropFields'"/>
        ...
        <xsl:if test="./popup='date' and not (/responseDetails/userDetails/allowcalendar)">
            <a title="{$calCaption}">
                <xsl:choose>
                    <xsl:when test="$showStatusInfo='false'">
                        <xsl:attribute name="onclick">javascript:enqselDropDownCalendar('value:<xsl:value-of select="i"/>:1:1')</xsl:attribute>
                        <xsl:attribute name="href">javascript:void(0)</xsl:attribute>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:attribute name="href">javascript:enqselDropDownCalendar('value:<xsl:value-of select="i"/>:1:1')</xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
                <xsl:call-template name="processTabIndex">
                    <xsl:with-param name="type" select="'tabIndexForDropFields'"/>
        ...
        <xsl:if test="./popup='frequency'">
            <a title="{$fquCaption}">
                <xsl:choose>
                    <xsl:when test="$showStatusInfo='false'">
                        <xsl:attribute name="onclick">javascript:enqselDropFrequency('value:<xsl:value-of select="i"/>:1:1')</xsl:attribute>
                        <xsl:attribute name="href">javascript:void(0)</xsl:attribute>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:attribute name="href">javascript:enqselDropFrequency('value:<xsl:value-of select="i"/>:1:1')</xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
                <xsl:call-template name="processTabIndex">
                    <xsl:with-param name="type" select="'tabIndexForDropFields'"/>
        ...
        <xsl:if test="./popup='recurrence'">
            <a title="{$recCaption}">
                <xsl:choose>
                    <xsl:when test="$showStatusInfo='false'">
                        <xsl:attribute name="onclick">javascript:enqselDropRecurrence('value:<xsl:value-of select="i"/>:1:1')</xsl:attribute>
                        <xsl:attribute name="href">javascript:void(0)</xsl:attribute>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:attribute name="href">javascript:enqselDropRecurrence('value:<xsl:value-of select="i"/>:1:1')</xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
                <xsl:call-template name="processTabIndex">
                    <xsl:with-param name="type" select="'tabIndexForDropFields'"/>
