				...
				<div id="tabFrame" class="tabbed_pane">
								...
								<xsl:when test="position()=1">
									<span class="active-tab" >
										...
										<a onclick="javascript:relativeCalendarDisplay(event)">
											...
											<img reldropfieldname="fieldName:ID.COMP.6" id ="tabAdd" title="Expand Tab" alt="Expand Tab" src="../plaf/images/default/deal/addTab.gif"  >
											</img>
										</a>
										</xsl:if>
									</span>
					...
					<div id="newPropertyDate" >
						...
						<form id="newPropertyDateForm" onmousedown="setCurrentForm('newPropertyDateForm')">
							...
							<input type="text" name="fieldName:ID.COMP.6" id="fieldName:ID.COMP.6" style="display: none;" value="" oldvalue="" data-oldValue=""/>
