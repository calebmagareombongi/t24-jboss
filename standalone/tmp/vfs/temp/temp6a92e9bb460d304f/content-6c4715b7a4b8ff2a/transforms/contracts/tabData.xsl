...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="monthDesc">
        <xsl:choose>
	        <xsl:when test="/responseDetails/userDetails/monthDesc!=''"><xsl:value-of select="/responseDetails/userDetails/monthDesc"/></xsl:when>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when test="./empty!=''">
                                ...
                                <td class = "empty">
                                    ...
                                    <xsl:attribute name="colspan"><xsl:value-of select="sp"/></xsl:attribute>
                                    <xsl:attribute name="style">width:<xsl:value-of select="sp"/>px !important</xsl:attribute>
                                </td>
                            </xsl:when>
                                                    ...
                                                    <xsl:choose>
                                                        <xsl:when test="./cLink!=''">
                                                            ...
                                                            <xsl:choose>
                                                                ...
                                                                <xsl:otherwise>
                                                                    <xsl:attribute name="href">javascript:docommand('<xsl:value-of select="cLink" />')</xsl:attribute>
                                                                </xsl:otherwise>
                                                            </xsl:choose>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                          <xsl:if test="$stripFrameToolbars = 'false'">
                                                             <xsl:attribute name="href">javascript:help('<xsl:value-of select="fn"/>','','','issueToken')</xsl:attribute>
                                                          </xsl:if>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:when test="./options!=''">
                                            <select>
                                                ...
                                                <xsl:attribute name="data-oldValue"><xsl:value-of select="v"/></xsl:attribute>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <xsl:attribute name="oldValue"><xsl:value-of select="options/option/thisoption[1]"/></xsl:attribute>
                                                        <xsl:attribute name="data-oldValue"><xsl:value-of select="options/option/thisoption[1]"/></xsl:attribute>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                                        ...
                                                        <xsl:otherwise>
                                                            ...
                                                            <xsl:choose>
                                                                <xsl:when test="radios/autoField!=''"> <!--Test if it is autoPopulated field -->
                                                                    ...
                                                                    <xsl:attribute name="data-oldValue"><xsl:value-of select="radios/autoField"/></xsl:attribute>
                                                                    </input>
                                                                </xsl:when>
                                                                <!-- TO bring the focus to radios after hot filed validation -->
                                                                <xsl:otherwise>
                                                                    <input type="hidden" name="fieldName:{fn}{in}" id="fieldName:{fn}{in}" value="" oldValue="" data-oldValue="" tabname="{$tabId}" />
                                                                </xsl:otherwise>
                                                            </xsl:choose>
                                        ...
                                        <xsl:when test="./ty='file'">
                                            <input type="hidden" id="fieldName:{fn}{in}" name="fieldName:{fn}{in}" tabname="{../../tabid}" value="{v}" oldValue="{v}" data-oldValue="{v}"/>
                                            <xsl:choose>
                                                <xsl:when test="./v=''">
                                                    ...
                                                    <!-- iframe size changed to accommodate the error message -->
                                                    <iframe id="fileUploadIframe" name="fileUploadIframe" style="width:300px;height:46px;border:0px;" tabIndex="0">
                                                        <xsl:attribute name="src">../jsps/fileUpload.jsp?&amp;fragment=<xsl:value-of select="$formFragmentSuffix"/>&amp;skin=<xsl:copy-of select="$skin"/>&amp;trans_upload=<xsl:value-of select="./trans_upload"/>&amp;trans_uploading=<xsl:value-of select="./trans_uploading"/>&amp;formToken=<xsl:value-of select="$csrfToken"/></xsl:attribute>
                                                    </iframe>
                                                </xsl:when>
                                                <xsl:otherwise>
                                        ...
                                        <xsl:when test="./ty='input'">
                                            ...
                                            <input tabindex="0" size="{sp}" id="fieldName:{fn}{in}" name="fieldName:{fn}{in}" tabname="{../../tabid}" value="{v}" oldValue="{v}" data-oldValue="{v}">
                                                ...
                                                <!-- Add date format if the field has associated date or frequency pop-up -->
                                                <xsl:if test="(./popup='date' or ./popup='frequency' or ./popup='recurrence') and not (/responseDetails/userDetails/allowcalendar)">
                                                    <xsl:attribute name="dateFormat"><xsl:value-of select="/responseDetails/userDetails/dateFormat"/></xsl:attribute>
                                                    <xsl:attribute name="monthDesc"><xsl:value-of select="$monthDesc"/></xsl:attribute>
                                                    <xsl:if test="(./popup='frequency' or ./popup='recurrence')">
                                                        <xsl:attribute name="frqFld">Y</xsl:attribute>
                                                    </xsl:if>
                                                </xsl:if>
                                        ...
                                        <xsl:when test="./ty='noinput'">
                                                <xsl:choose>
                                                    ...
                                                    <input type="hidden" id="fieldName:{fn}{in}" name="fieldName:{fn}{in}" value="{v}" oldValue="{v}" data-oldValue="{v}">
                                                            <xsl:if test="./fieldError='Y'">
                                                                <xsl:attribute name="fieldError">Y</xsl:attribute>
                                                            </xsl:if>
                                                        </input>
                                                         ...
                                                         <xsl:otherwise>
                                                             <span>
                                                                <xsl:variable name="className">
                                                                    <xsl:choose>
                                                                        <xsl:when test="class!=''">
                                                                            <xsl:value-of select="$dealboxClass"/>
                                                                        </xsl:when>
                                                                        <xsl:otherwise>
                                                                            <xsl:variable name="disabledText" select="'disabled_'"/>
                                                                            <xsl:value-of select="$disabledText"/><xsl:value-of select="$dealboxClass"/>
                                        ...
                                        <xsl:when test="./ty='hidden'">
                                            <input type="hidden" name="fieldName:{fn}{in}" value="{v}" oldValue="{v}" data-oldValue="{v}" isHidden ="YES">
                                                <xsl:if test="./fieldError='Y'">
                                                    <xsl:attribute name="fieldError">Y</xsl:attribute>
                                                </xsl:if>
                                            </input>
                                        ...
                                        <xsl:when test="./ty='text'">
                                            <textarea id="fieldName:{fn}{in}" name="fieldName:{fn}{in}">
                                                ...
                                                <xsl:attribute name="onblur">javascript:setCurrentTabName('<xsl:value-of select="../../tabid"/>');formatTextArea(event, '<xsl:value-of select="l"/>')</xsl:attribute>
                                                <!-- fn represents the node 'fieldname'-->
                                                <!-- in represents the node 'inpname'-->
                                                <xsl:attribute name="tabindex">0</xsl:attribute>
                                                <xsl:attribute name="tabname"><xsl:value-of select="../../tabid"/></xsl:attribute>
                        ...
                        <xsl:call-template name="fieldEvents" />
                                            ...
                                            <input type="hidden">
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="v=chkValue">
                                                       ...
                                                       <xsl:attribute name="data-oldValue"><xsl:value-of select="chkValue"/></xsl:attribute>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <xsl:attribute name="oldValue"><xsl:value-of select="unchkValue"/></xsl:attribute>
                                                        <xsl:attribute name="data-oldValue"><xsl:value-of select="unchkValue"/></xsl:attribute>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </input>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:if test="./popup='upload'">
                                        <a>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$showStatusInfo='false'">
                                                    <xsl:attribute name="onclick">javascript:upload('<xsl:value-of select="df" />','issueToken')</xsl:attribute>
                                                    <xsl:attribute name="href">javascript:void(0)</xsl:attribute>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <xsl:attribute name="href">javascript:upload('<xsl:value-of select="df" />','issueToken')</xsl:attribute>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                            <xsl:attribute name="tabindex">-1</xsl:attribute>
                                            <xsl:attribute name="title"><xsl:value-of select="/responseDetails/window/translations/attachment"/></xsl:attribute>
                                            <img  onfocus ="focusonKey('inline',event);" onblur = "hideTooltip(event);">
                                                <xsl:attribute name="onkeypress">javascript:upload('<xsl:value-of select="df"/>','issueToken')</xsl:attribute>
                                                <xsl:attribute name="title"><xsl:value-of select="/responseDetails/window/translations/attachment"/></xsl:attribute>
                                                <xsl:call-template name="processTabIndex">
                                                    <xsl:with-param name="type" select="'tabIndexForDropFields'"/>
                                                </xsl:call-template>
                                    ...
                                    <xsl:if test="./popup='relDate'">
                                        ...
                                        <a>
                                            ...
                                            <img onfocus ="focusonKey('inline',event);" onblur = "hideTooltip(event);" onkeypress = "relativeCalendarDisplay(event);">
                                                ...
                                                <xsl:attribute name="reldropfieldname"><xsl:value-of select="df"/></xsl:attribute>
                                                <xsl:if test="se!=''">
                                                        <xsl:attribute name="enrichmentOnly"><xsl:value-of select="se"/></xsl:attribute>
                                                </xsl:if>
                                            </img>
            ...
            <xsl:choose>
                ...
                <xsl:when test="./fenqlist != '' and not (/responseDetails/userDetails/allowcontext)">
                    <a onfocus = "focusonKey('inline',event);" onblur = "hideTooltip(event);">
                        ...
                        <xsl:variable name="tempEnqDescs">
                            <xsl:call-template name="escape-apos">
                                <xsl:with-param name="string" select="./fenqdescs"/>
                            </xsl:call-template>
                        </xsl:variable>
                        <!-- To avoid xss security vulnerability remove parentheses from enquiry description -->
                        <xsl:variable name="fenqdescs">
                            <xsl:call-template name="remove-parentheses">
                                <xsl:with-param name="string" select="$tempEnqDescs"/>
                            </xsl:call-template>
                        </xsl:variable>
                        ...
                        <xsl:attribute name="href">javascript:doFieldContext('<xsl:value-of select="./fenqlist"/>','<xsl:value-of select="./fenqnames"/>','<xsl:value-of select="$fenqdescs"/>','<xsl:value-of select="./df"/>','<xsl:copy-of select="$skin"/>','<xsl:value-of select="$rawvalue"/>','<xsl:value-of select="./fn"/>','<xsl:value-of select="./in"/>','issueToken')</xsl:attribute>
                        <xsl:call-template name="processTabIndex">
                            <xsl:with-param name="type" select="'tabIndexForInfoIcon'"/>
                        </xsl:call-template>
