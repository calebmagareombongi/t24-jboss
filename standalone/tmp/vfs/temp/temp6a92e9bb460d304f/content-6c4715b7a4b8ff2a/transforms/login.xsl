...
<td width="80%"> </td>
	...
	<xsl:template name="login-form">
		...
		<form name="login" method="post" action="BrowserLoginServlet" AUTOCOMPLETE="OFF">
			<!-- add dummy username and password fields to avoid autopopulate -->
	...
	<!-- To fetch the links in home page ,when sign off is made  -->		
	<xsl:for-each select="/responseDetails/logoff/links/link">
	<td>
					<a class="link">
