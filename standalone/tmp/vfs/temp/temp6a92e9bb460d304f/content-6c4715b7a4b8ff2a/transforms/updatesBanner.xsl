            									...
            									<a>
														<xsl:choose>
															<xsl:when test="$showStatusInfo='false'">
																<xsl:attribute name="onclick">javascript:t24UpdatesDoCommand('QUERY EB.UPDATE.CLIENT.SYSTEMS')</xsl:attribute>
																<xsl:attribute name="href">javascript:void(0)</xsl:attribute>
															</xsl:when>
															<xsl:otherwise>
																<xsl:attribute name="href">javascript:t24UpdatesDoCommand('QUERY EB.UPDATE.CLIENT.SYSTEMS')</xsl:attribute>
															</xsl:otherwise>
														</xsl:choose>
						...
						<tr >
							...
							<td >
								<a>
									<xsl:choose>
										<xsl:when test="$showStatusInfo='false'">
											<xsl:attribute name="onclick">javascript:t24UpdatesDoCommand('QUERY EB.UPDATES.INBOX')</xsl:attribute>
											<xsl:attribute name="href">javascript:void(0)</xsl:attribute>
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="href">javascript:t24UpdatesDoCommand('QUERY EB.UPDATES.INBOX')</xsl:attribute>
										</xsl:otherwise>
									</xsl:choose>
							    	<font face="Verdana" color="#336699" size="2" >
										Messages
							...
							<td >
								<a>
									<xsl:choose>
										<xsl:when test="$showStatusInfo='false'">
											<xsl:attribute name="onclick">javascript:t24UpdatesDoCommand('UTIL OS.UPLOAD.EUS.FILE');</xsl:attribute>
											<xsl:attribute name="href">javascript:void(0)</xsl:attribute>
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="href">javascript:t24UpdatesDoCommand('UTIL OS.UPLOAD.EUS.FILE');</xsl:attribute>
										</xsl:otherwise>
									</xsl:choose>
							    	<font face="Verdana" color="#336699" size="2" >
										Add System
       									...
       									<xsl:choose>
       										<xsl:when test="responseDetails/banner/isUpdates">
       											<a>
													<xsl:choose>
														<xsl:when test="$showStatusInfo='false'">
															<xsl:attribute name="onclick">javascript:t24UpdatesDoCommand('QUERY EB.AVAILABLE.UPDATES')</xsl:attribute>
															<xsl:attribute name="href">javascript:void(0)</xsl:attribute>
														</xsl:when>
														<xsl:otherwise>
															<xsl:attribute name="href">javascript:t24UpdatesDoCommand('QUERY EB.AVAILABLE.UPDATES')</xsl:attribute>
														</xsl:otherwise>
													</xsl:choose>
							    					<font face="Verdana" color="#336699" size="2" >
														Available Updates
						        			...
						        			<xsl:otherwise>
            									<a>
            										<xsl:choose>
														<xsl:when test="$showStatusInfo='false'">
															<xsl:attribute name="onclick">javascript:t24UpdatesDoCommand('QUERY EB.NOFILE.SERVICE.PACKS')</xsl:attribute>
															<xsl:attribute name="href">javascript:void(0)</xsl:attribute>
														</xsl:when>
														<xsl:otherwise>
															<xsl:attribute name="href">javascript:t24UpdatesDoCommand('QUERY EB.NOFILE.SERVICE.PACKS')</xsl:attribute>
														</xsl:otherwise>
													</xsl:choose>
							    					<font face="Verdana" color="#336699" size="2" >
