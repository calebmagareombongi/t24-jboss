 ...
 * @return {void}
 */ 
function continueWindow(skin,compId,user,cfwstage,windowName,formToken)
{	
...
function continueFromT24()
{
	...
	var formToken = getFormFieldValue("generalForm","formToken");
	if((cflowstage!='') && (cflowstage!=undefined))
		continueWindow(skin,compId,user,cflowstage,"_parent",formToken);
}
